...
import { CourseDetails, InstructorProfile, AttendanceRecord } from '@/types/course'; // crea este archivo de tipos si no lo tienes
...
export default function CourseDetailPage() {
  ...
  const { data: course, isLoading: isCourseLoading, error: courseError } = useDoc<CourseDetails>(courseRef);
