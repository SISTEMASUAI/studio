...
import { Folder, File, Tv, AlertTriangle, BookOpen } from 'lucide-react';
        ...
        <div className="pt-4 border-t">
          <div className="bg-muted/50 p-4 rounded-lg">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-sm">Funcionalidad en desarrollo</p>
                <p className="text-sm text-muted-foreground mt-1">
                  La subida, previsualización y descarga real de archivos se implementará próximamente.
                  Actualmente solo se muestra una vista estática.
                </p>
              </div>
            </div>
          </div>
