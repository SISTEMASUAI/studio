...
import { FileText, CheckCircle, XCircle, Library, BookOpen, Mail } from 'lucide-react';
...
const classmates = [
    ...
    { id: '2', name: 'Carlos Sanchez', avatar: 'https://i.pravatar.cc/150?u=carlos' },
    { id: '3', name: 'Beatriz Torres', avatar: 'https://i.pravatar.cc/150?u=beatriz' },
    { id: '4', name: 'David Flores', avatar: 'https://i.pravatar.cc/150?u=david' },
]
          ...
          <CardContent>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {classmates.map(student => (
                    <div key={student.id} className="flex items-center gap-3 p-2 rounded-lg hover:bg-accent">
                        <Avatar>
                        ...
                        <div>
                            ...
                            <Button variant="ghost" size="sm" className="h-auto p-0 text-xs text-muted-foreground hover:text-primary"><Mail className="mr-1 h-3 w-3"/>Contactar</Button>
                        </div>
                    </div>
                ))}
            </div>
